...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        ...
        auth.requestMatchers(HttpMethod.POST, "/api/usuarios").permitAll()// pode ser acessado sem o cara estar logado
        .anyRequest().authenticated())//usuario tem q ta autorizado e autentificado
