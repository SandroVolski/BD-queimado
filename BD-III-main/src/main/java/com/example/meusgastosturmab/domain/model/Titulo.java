...
public class Titulo{
    ...
    @JoinTable(
        ...
        inverseJoinColumns = @JoinColumn(name = "idCentroDeCusto") //inverseJoin, pega de outra tabela 
        //cria a relacao dessas duas tabelas, sem precisar criar uma nova tabela
    )
